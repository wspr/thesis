...
\ZKSforceinclV = \ZKSforceincl{0,2} \frac{\ZKSdisp}{\ZKSlengthcomp{0,2}}
...
right is
\begin{dmath}
\ZKSforceinclH\bigg|_{\text{right}} = -\ZKSforceinclH{-\ZKSshift,2}
\end{dmath}.
...
\begin{dmath}
\ZKSforcetotalH=\ZKSforceinclH-\ZKSforceinclH{-\ZKSshift,\ZKSdisp}+\ZKSforcevertH
\end{dmath},
...
\begin{dmath}[label=stiffness,compact]
  \magstiffness = \frac{\partial}{\partial\cdz} \magforce
...
\end{equation}
with force $\magforce{\mdim,x}$ in Newtons, magnet size $\mdim$ and centre displacement
