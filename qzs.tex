...
\chapterprecis{
  ...
  (one mechanical, one magnetic) to show how `\qzs/' can be used to aid
  ...
  forces as well as vertical forces are investigated and some previously unreported regions of
