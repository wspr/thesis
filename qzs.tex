...
$\ZKSratio$.\figlabel{ZKSforce-plain}]
  {\hspace*{-1.5cm}\psfragfig{PhD/Simulations/ZKS/fig/ZKSforce-plain}}
\hfil
\subbottom
...
force/displacement plot as shown the horizontal axis of \figref{heq}. For a maximum
...
\Eqref{saturate} is a maximum displacement (`saturation') criterion to ensure that the lower
...
\begin{figure}[htbp]
  ...
  \end{wide}
\caption[Regions of $\mdim$ and $\ngap$ satisfying the (other) stability criterion.]{Regions of $\mdim$, $\ngap$ satisfying the stability criterion
...
\caption[Regions of $\mdim$ and $\ngap$ satisfying all design criteria.]{Regions of $\mdim$ and $\ngap$ satisfying all design criteria,
  ...
  resonance frequency $\freq$ of the desired system.}
  \figlabel{cons-all}
\end{figure}
