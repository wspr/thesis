...
\caption{Axial displacement down the centreline.\figlabel{gauss-axial}}
\end{subfigure}\hfil
\begin{subfigure}
\fbox{\parbox{5cm}{THOSE PROSTHETICS FOOLS DIDN'T PUT THIS GRAPH IN THEIR REPORT}}
\caption{Lateral displacement with a certain offset.\figlabel{gauss-lateral}}
\end{subfigure}
\lofcaption{
...
\begin{figure}
  ...
  \lofcaption{`\QZS/' vertical spring forces \vs\ vertical displacement from the centred position.}{ The magnets are \SI{20}{mm} cubes with \SI{1}{T} magnetisation, and there is \SI{80}{mm} between the top and bottom magnet centres.}
...
\subsection{Combined \qzs/ spring}
\seclabel{combined-spring}
