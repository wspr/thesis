...
Specifically, for the case of zero offset $\mbqoffset$ between the magnets (\Figref{mbq-wvf-angle-1}), it can be seen that at a magnet angle of $\mbqmagangle=\SI{35}{\degree}$ the natural frequency is almost independent of force for a large range of applied load (approximately $\SI{30}{N}\pm\SI{10}{N}$).
...
Increasing the magnet gap $\mbq$ changes the force and stiffness relationships of the spring; \Figref{mbq-wvf-angle-2} shows the same plot with a magnet gap ratio of \num{0.25}.
