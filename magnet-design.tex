...
\begin{figure}
   ...
   displacement in the $\az$ direction.}{ Dashed line for the total forces shows the region of instability.}
...
\begin{figure}[t]
  ...
  \end{subfigure}
  \lofcaption{Top view of geometry used for analysing the magnetic spring with stable rotation.}{ Magnet remanence was normalised at \SI{1}{T}.}
