...
\begin{figure}
  \grf[angle=90,scale=0.717]
{Simulations/Single_magnets/stable_rotation/eps20051124/example-8-mag-spring}
...
\begin{figure}
  \begin{wide}
    \raggedout
    \psfragfig{\phdpath magrotate/fig/stablerot-x}\hfil
    \psfragfig{\phdpath magrotate/fig/stablerot-y}\hfil
    \psfragfig{\phdpath magrotate/fig/stablerot-z}\par\bigskip
    \psfragfig{\phdpath magrotate/fig/stablerot-rx}\hfil
    \psfragfig{\phdpath magrotate/fig/stablerot-ry}\hfil
    \psfragfig{\phdpath magrotate/fig/stablerot-rz}
  \end{wide}
  \caption{
...
Demonstrative results are shown in \figref{demon-stable-rotation} for some particular spring parameters.
...
Stability results vary with the size of the stabilising
