...
\begin{gather}
\mass \ddot {\disphoriz}\fn\Time + \damping \gp{\dot {\disphoriz}\fn\Time - \dot {\disturb}\fn\Time} - \forceMag_y\fn{0,\disphoriz\fn\Time-\disturb\fn\Time,\dispvert\fn\Time} + \gainDisp \gp{\disphoriz\fn\Time-\disturb\fn\Time} = 0 \,, \\
\mass \ddot {\dispvert}\fn\Time + \damping \dot {\dispvert}\fn\Time - \forceMag_z\fn{0,\disphoriz\fn\Time-\disturb\fn\Time,\dispvert\fn\Time} + \mass \gravity = 0 \,,
\end{gather}
...
\begin{wide}
  ...
  \end{subfigure}\hfil
  \begin{subfigure}
  \scalebox{1.05}{\psfragfig{\phdpath Simulations/Coupling/fig/mag-couplingratio-equil}}
...
\begin{dmath}
\mbqmass \mbqhacc \fn\Time = \mbqhforce\fn{\mbqhdisp\fn\Time,\mbqvdisp\fn\Time,\mbqrotz\fn\Time} - \mbqhdamp \mbqhvel \fn\Time
\end{dmath},
\begin{dmath}
\mbqmass \mbqvacc \fn\Time = \mbqvforce\fn{\mbqhdisp\fn\Time,\mbqvdisp\fn\Time,\mbqrotz\fn\Time} - \mbqvdamp \mbqvvel \fn\Time -\mbqmass \gravity
\end{dmath},
\begin{dmath}
\mbqmomentofinertia \mbqaccrotz \fn\Time = \mbqptorque\fn{\mbqhdisp\fn\Time,\mbqvdisp\fn\Time,\mbqrotz\fn\Time} - \mbqzrotdamp \mbqvelrotz \fn\Time
\end{dmath},
\end{dgroup}
