...
This chapter investigates a number of different configurations for such magnetic springs, some of which having been used to various degrees in the literature and some of which are novel.
...
The analyses performed in this thesis are generally normalised by magnet strength; \ie, the remanence magnetisation for theoretical calculations are usually assumed to be $\remanence=\SI{1}{T}$.
...
\end{wide}
\caption[
  Magnetic field measurements of a cylindrical permanent magnet.
]{
  Magnetic field measurements of an \maggrade{35} \diameter\SI{100x30}{mm} cylindrical permanent magnet.
...
If the constraint is removed, it will be naturally unstable horizontally due to Earnshaw's theorem (see \secref{earnshaw}).
