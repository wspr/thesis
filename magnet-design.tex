...
\end{subfigure}
 \begin{subfigure} \grf{Simulations/Single_magnets/stable_rotation/eps/stable-rotation-width-test}
  \caption{Accompanying spring width force curves for a depth of three inches (equivalent label of 3 in \figlabel{stable-rotation-depth-test-2}).}
...
\midrule
\SI{50.8}{mm} & \$17 & 1 & \$17 \\
\SI{15.9}{mm} & \$1.75 & 6 & \$10.5 \\
\SI{9.5}{mm} & \$0.70 & 18 & \$12.6 \\
\bottomrule
\end{tabular}
\end{table}

\subsection{Dual coil simulations}\seclabel{dualcoil}
