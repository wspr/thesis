...
The results shown in \figref{xz-magforce} bely this possibility; in fact, for cube magnets it can be seen that the forces for displacement orthogonal to the magnetisation are exactly half those for magnets which are parallel.
...
In other words, for equal $\nu$ a cylindrical and cuboid magnet will have the same face area.
  \note{A technique known as `squaring the circle'.}
