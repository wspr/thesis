...
\begin{figure}[!b]
  ...
  \subbottom[Relative displacement trace.]{\psfragfig{\jobname/coupling-oscillations}}
...
\end{wide}
  \lofcaption{
    ...
    The range of displacement is one half of the magnet width.
  }
\end{figure}
  ...
  \begin{figure}[p]
    \begin{wide}
      ...
      \subfloat[$\ax$ forces.\figlabel{iso-#2-x}]{%
        \psfragfig
          {PhD/Simulations/Single_magnets/all_springs/frag/#2-xforce}%
      }\hspace*{-3mm}%
      \subfloat[$\ay$ forces.\figlabel{iso-#2-y}]{%
        \psfragfig
          {PhD/Simulations/Single_magnets/all_springs/frag/#2-yforce}%
      }\hspace*{-3mm}%
      \subfloat[$\az$ forces.\figlabel{iso-#2-z}]{%
        \psfragfig
          {PhD/Simulations/Single_magnets/all_springs/frag/#2-zforce}%
      }%
      }%
    \end{wide}
