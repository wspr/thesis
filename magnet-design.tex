...
\begin{dmath}[label=coileccfz]
  ...
  \Int{f_z\fn{\lengthMag/2}-f_z\fn{-\lengthMag/2}}
    {\distra{1}',\iradiusMag,\oradiusMag}
    {\distra{2}',0,2\pi}
    {\distrb{1},\iradiusCoil,\oradiusCoil}
    {\distrb{3},\offsetCoilMag-\lengthCoil/2,\offsetCoilMag+\lengthCoil/2}
...
\begin{dmath}
  ...
  f_2\fn{l}
  \frac{
    2 \distra{1}' \distrb{1} \gp{ \distrb{1} - \distra{1} }
    \sqrt{
      1-\frac{2 \distra{1} \distrb{1} \gp{\cos\fn{\phi_1}-1}}
             {\gp{l-\distrb{3}}^2+\gp{\distrb{1}-\distra{1}}^2}
    }
  }
  {
   \gp{ \gp{l-\distrb{3}}^2 + \gp{\distra{1}+\distrb{1}}^2 }
   \sqrt{
         \distrb{1}^2
         - 2 \cos\fn{\phi_1} \distra{1} \distrb{1}
         + \gp{l-\distrb{3}}^2+\distra{1}^2
        }
  }
\end{dmath},
...
\begin{dmath}
  f_2\fn{l} =
     ...
     E\fn{
      \frac{\phi_1}{2}-\pi \middle|
      \frac{ - 4 \distra{1} \distrb{1}}
            {\gp{l-\distrb{3}}^2+\gp{\distrb{1}-\distra{1}}^2}
     }
\end{dmath}.
For \eqref{coileccfz}, only a single symbolic integration has been performed
(in the variable $\distrb{2}$). A second integration yields
\begin{dmath}[label=coileccfz]
  \frac{NI\remanence}{4A\pi}
  \Int{
    \sum_{e_1,e_2\in\{1,-1\}^2}
