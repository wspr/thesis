...
Then $\mbqforce_1=\mbqrot{\mbqmagangle} \mbqmforce_1$ and $\mbqforce_2=\mbqrot{\mbqcompmagangle}\mbqmforce_2$, where $\mbqcompmagangle=\pi-\mbqmagangle$, $\mbqmforce_{1}$ and $\mbqmforce_{2}$ are the forces between the magnet pairs in the local coordinate systems of the base magnets, and $\mbqrot{\cdot}$ is the planar rotation matrix given in \eqref[vref]{rotZ}.
