...
\end{dmath}.
The transmissibilities due to the influence of relative velocity gain and absolute velocity gain are shown in \figref{vel-vs-sky} with parameters $\massMass=\SI{1}{kg}$, $\dampingRel=\SI{1}{kg/s}$, $\stiffnessRel=\SI{10}{N/m}$, and the respective gains $\gainVel$ and $\gainSky$ ranging from $0$ to $5$ as indicated.
