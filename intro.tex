...
\begin{figure}
  ...
  \hfil
  \subbottom[Vibration isolation from disturbance input $\dispBase$.\figlabel{simple-isolation}]{\asyinclude{\jobname/vibration-base}}
...
\begin{wide}
  \begin{subfigure}[0.44]
    ...
    \caption{
      Transmissibility reduction at resonance \vs\ stiffness, for a range of absorber damping values.
  ...
  \begin{subfigure}[0.44]
    ...
    \caption{
      \expandafter\MakeUppercase\RMS/ transmissibility \vs\ stiffness, for a range of absorber damping values.
...
The first half of this thesis is focused specifically on the analysis and design of purely magnetic systems, beginning with the theory on calculating forces between magnets (\chapref{magnet-theory}).
\Chapref{magnet-design} then discusses load bearing systems composed of collections of singular magnets in various geometries and configurations, culminating in the analysis of a novel magnetic support that uses inclined magnets to achieve load-invariant resonance frequency.
These studies conclude in \chapref{multipole} with a discussion and analysis of using multipole or `Halbach' arrays, which are composed of many variously-oriented magnets, for improving the load bearing capabilities for magnetic supports.
...
In discussing \qzs/ systems for vibration isolation, \chapref{qzs} begins with a planar analysis of a more typical spring-based design from the literature.
...
Finally, a prototype based on this magnetic system is presented in \chapref{xpmt} demonstrating results to illustrate low frequency vibration isolation and the ability of active vibration control to improve the vibration transmissibility.
\chapref{conc} summarises the main findings from the preceding chapters, and suggests a list of possible future directions to take for subsequent research.
...
A discussion of the philosophy behind this effort and a summary of the reproducible work in this thesis are discussed in \chapref{repro-research}.
...
\item\fullcite{robertson2013-aas-zks}
\item\fullcite{robertson2013-aas-qzs}
\end{itemize}
