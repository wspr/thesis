...
Conversely, if the \RMS/ transmissibility of an entire frequency band is calculated (\figref*{rms-inertial}) it can be seen that lower absorber damping \emph{decreases} the overall vibration reduction.
