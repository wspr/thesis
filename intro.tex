...
Magnetic levitation (\ie, using forces to prevent things from moving); its impossibility and exceptions to that restriction.
\item[\Secref{magnetsisolation-apps}]
The literature of vibration isolation platforms with magnetic forces.
\end{description}
