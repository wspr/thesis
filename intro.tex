...
The original germ of an idea for this project was to design and build a vibration isolation table using non-contact magnetic springs.
...
\Eg, adding mass reduces the resonance frequency, which improves vibration isolation; however, it is not always possible to do so \dash consider, say, weight requirements in a vehicle.
...
For the conductive case, a permanent magnet may be used to increase the field strength of the electromagnet at the expense of added viscous damping (which may not be undesirable).
