...
\end{dmath}.
First assume that there is no input force; taking the Laplace tranform and rearranging produces the transmissibility $\transmissibility$ of the system in the frequency domain:
...
Active damping reduction has been performed to aid the efficiency of vibration neutralisers \cite{kidner1998}, which are discussed briefly in \secref{vibneut}.
