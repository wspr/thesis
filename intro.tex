...
the presence of damping. \note{This theme of the desirability of low mechanical
damping re-occurs at other points in this thesis (crossref).}
...
rolling structure via which a \vibeneut can be mounted to good effect
...
\secref{qzs-explore} and \secref{qzs}).
...
\textcite{stephen2006} talks about energy harvesting with micro-actuators, and
