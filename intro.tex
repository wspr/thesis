...
For a given mass, this can be achieved by reducing the stiffness of the support, or by adding a negative stiffness element in parallel with the system \cite{lee2007-jsv,xing2005} (some examples of which are looked at in more detail later in \secref{qzs-explore}).
