...
The first half of this thesis is focused specifically on the analysis and design of purely magnetic systems, beginning with the theory on calculating forces and torques between magnets of various shape and geometry (\chapref{magnet-theory}).
...
\citeconf{robertson2013-aas-zks} \emph{Under review}.
\citeconf{robertson2013-aas-qzs} \emph{Under review}.
\end{itemize}
