...
The absolute and relative velocity feedback results may be compared by calculating the \RMS/ transmissibilities over a frequency range of interest ($\sqrt{\Int{\Abs{\transmissibility{\ii\freq}}}{\freq,\freq_1,\freq_2}}$) as a function of increasing feedback gain for the two cases.
