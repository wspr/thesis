...
\subsubsection{Combination approaches of linear feedback}

The active feedback methods introduced in \seclabel{fundavibes} are orthogonal in the sense that more than one scheme may be applied in parallel.
