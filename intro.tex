...
\epigraph{In my experience I found that the most effective way to express something in order to make others understand is to use the simplest language. Also I learned from teaching that the more rigid the language the less effective it~is.}{\epicite{mahathera1990-mindfulness}}
...
\item [\chapref{conc}]
      A summary of the main findings from the preceding chapters, and a list of possible future directions for subsequent research.
\end{description}
...
\newcommand\citeconfx[1]{%
  \item[\citeyear{#1}]
  \citetitle{#1},
  \citefield{#1}{booktitle}. Under review.\\
}
