...
\fixme{The following paragraphs are too `bullet-list'-like.}
...
\fixme{this section is terrible.}
...
\fixme{Use the above literature to justify not using these techniques.}
...
\Vibneut/s have been used to mitigate seismic vibrations in large buildings, but their mass dependence makes their application rather tricky and often impractical. \fixme{cite}
...
The most common form this takes is via an unstable attractive vertical force to directly compensate for gravity; later, \fixme{crossref} vertically-passive schemes are seen that require active control in the horizontal directions to maintain stability.
