...
These equations, particularly \eqref{nforce}, are useful in \secref{qzs} for the analysis of a magnetic in which the magnet size can be factored away from consideration.
...
Of the tests performed, two sets of results are shown in \figref{magrotmeas}: \maggrade{45} \SI{15x20x10}{mm} cuboids and \maggrade{52} \SI{25x25x10}{mm} cuboids.
