...
\begin{equation}
\vect F_m = \frac{J_1 J_2}{4\pi\mu_0}
  \sum_{(\e1,\dots,\e6)\in\{1,-1\}^6}
  \left( \vect f_m(\vect d)
  \cdot \prod_{i=1}^6 \e i
  \right)
,
\eqlabel{akoun}
\end{equation}
