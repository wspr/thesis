...
A metric of improvement to the vibration isolation characteristics of the system can be shown by calculating
...
\Figref{cl-reduction} shows the reduction in \RMS/ transmissibility
$\RMSof{\transmissibility}$ as the negative feedback gain increases.
The overall transmissibility reduction is calculated as $1-\RMSof{\transmissibility}/\transmissibility_0$, where $\transmissibility_0$ is the \RMS/ transmissibility of the open loop system.
...
\begin{figure}
  ...
  \caption[{Transmissiblity reduction for increased velocity feedback gain.}]{Effect on overall transmissiblity $\RMSof{\transmissibility}$ between \SI{1}{Hz} and \SI{11}{Hz} as velocity feedback gain was increased.}
