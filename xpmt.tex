...
\begin{figure}[p]
  ...
  \lofcaption{Curve fit model of \figref{ol-undamped-frflin}.}{ Gray lines show the original data.}
  \figlabel{ol-undamped-frflin-fit}
\end{figure}

\begin{figure}[p]
  \psfragfig{PhD/Experiments/XPMT/latex/ol-damped-frflin-fit}
  \lofcaption{Curve fit model of \figref{ol-damped-frflin}.}{ Gray lines show the original data.}
