...
\begin{figure}
  \begin{wide}
    \asyinclude{PhD/Figures/Rig/rig-schematic}
  \end{wide}
...
\begin{figure}
  \includegraphics[width=0.8\textwidth]{PhD/Experiments/Rig/photo.jpg}
...
\begin{figure}
  \begin{wide}
  \begin{sidefigure}
  \asyinclude{PhD/Figures/Rig/rig-coil}
  ...
  { Zero displacement is as shown in \figref{rig-dual-coil}, and
...
\begin{figure}[p]
  \psfragfig{PhD/Experiments/XPMT/latex/ol-undamped-frflin}
  \caption
...
\begin{figure}[p]
  \psfragfig{PhD/Experiments/XPMT/latex/ol-damped-frflin}
  \caption
...
\begin{figure}
  ...
  \lofcaption{Open loop measurements without the coil connected; the transmissibility is calculated with \eqref{frfnl}.}{ Black markers show resonant frequencies and the points at twice each resonant frequency, indicating the higher-order dynamics.}
...
\begin{figure}
  \psfragfig{PhD/Experiments/XPMT/latex/cl-reduction}
...
\begin{figure}
  ...
  {Closed loop simulation with gains $\{0, 5, 10, 20, 50, 99\}$ percent of the maximum gain before instability in \figref{cl-filter}.}
\end{figure}
