...
with that same height and equal face area, such as shown in \figref{equal-area}.
...
Comparing \figref{cl-filter} with \figref{cl-results} shows a clear similarity.
