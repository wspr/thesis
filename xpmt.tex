...
A single \dof/ system was designed using one pair of magnets in repulsion for load bearing and one pair in attraction for stiffness reduction (\figref*{rig}).
...
\figref{cl-results}) have little impact below this frequency.
