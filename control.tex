...
\begin{figure}[p]
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-vattr-kz}
    \caption{Vertical stiffness (unstable).\figlabel{K-V-attr-Z}}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-vattr-ky}
...
\begin{figure}[p]
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-vrepl-kz}
    \caption{Vertical stiffness (stable).\figlabel{K-V-repl-Z}}  
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-vrepl-ky}
...
\begin{figure}
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-zerok-fxrange}
  ...
  \par
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-zerok-fgap}
...
mass $m$)
\begin{dmath}
m\ddot x - K x^2 = 0 . \eqlabel{dynamics}
\end{dmath}
...
\begin{wide}
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-sim5-disp}    
    \caption{Vertically repelling spring.\figlabel{active-sim5-disp}}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \grf{Simulations/Active2006/eps/active-sim2-disp}
...
\begin{figure}
  \begin{wide}
    \begin{subfigure}
      \grf{Simulations/Active2006/eps/active-base-powerspec-x7}
      \caption{Vertically repelling spring.}
    \end{subfigure}
    \hfill
    \begin{subfigure}
      \grf{Simulations/Active2006/eps/active-base-powerspec-x4}
...
\begin{figure}
  \centering
  \begin{subfigure}
    \grf{Simulations/ICSV14/eps/icsv-ideal}
    \caption{States of the system\figlabel{converge-states}}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \grf{Simulations/ICSV14/eps/icsv-ideal-params.eps}
...
\begin{figure}
  \centering
  \begin{subfigure}
    \grf{Simulations/ICSV14/eps/icsv-adapt-noise-t}
    \caption{With parameter adaptation.\figlabel{adapt-noise}}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \grf{Simulations/ICSV14/eps/icsv-ssnoise-t}
