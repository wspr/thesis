...
\fxfatal{draw accompanying graphs}
...
force curve has the advantage in practice (\fxfatal{crossref}) of
...
\end{dmath}
Similarly to before (\fxfatal{crossref??}), for stability
\begin{dmath}
...
\fxfatal{refer back to the lit review here}
...
\begin{figure}
  \fxfatal{Draw asy schematics for magnetic springs}
 %\null\hfill
 %\subfloat
