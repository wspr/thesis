...
Solid, labelled lines have a safety factor of 100\%; dashed lines represent the same curves using a \SI{20}{\%} safety factor on current; they exhibit the same shape with a proportionally lower peak amplitude.
}
