...
Force versus displacement calculations are performed with these three techniques (\eqref{filamentforce,shellforce,cylforcez}) using the physical parameters defined in \tabref{magcoil-thin-compare-param}; these calculations are shown in \figref{magcoil-thin-compare} and it can be see that the three models produce comparable results.
...
\begin{figure}
\psfragfig{magcode/examples/fig/magcoil-magratio}\\[0.5cm]
...
Solid, labelled lines have a safety factor of 100\%; dashed lines represent the same curves using a $S=20\%$ safety factor; they exhibit the same shape with a proportionally lower peak amplitude.
}
\end{figure}
