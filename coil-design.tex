...
\begin{dmath}[label=eq:cylforcez-ecc]
F_{z_4}=
\frac{\const}{\pi}
\Int{
...
\begin{dmath}[label=eq:eccfilament]
...
%\begin{dmath}[label=eq:eccfilamentecc]
...
\begin{figure}
\centering
\psfragfig{examples/fig/ecc-compare}
...
\begin{figure}
\centering
\psfragfig{examples/fig/ecc-vary}
