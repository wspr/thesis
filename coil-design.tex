...
\begin{figure}
  \centering
  \asyinclude{PhD/Figures/Coil/coil-magnet.asy}
...
\begin{figure}
  \centering
  \asyinclude{PhD/Figures/Coil/coil-schem}
...
\begin{figure}
    \hspace{1.4cm}%
    \makebox[0pt][l]{\asyinclude{PhD/Figures/Coil/coil-shell.asy}}%
    \makebox[0pt][l]{\hspace{-0.5\linewidth}\asyinclude{PhD/Figures/Coil/coil-filament.asy}}%
