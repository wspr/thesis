...
\caption{Schematic of a four-magnet Halbach array with variable magnet sizes. The number of magnets per wavelength $\mupmagperwave=4$ for all arrays of this type except in the degenerate case of $b=0$, hence $\mupmagperwave=2$.}
\figlabel{magratio}
\end{figure}
