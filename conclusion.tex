...
For this study, the geometric parameters to define a multipole array were introduced, and the effect of varying these parameters to achieve larger peak forces for a given array volume were presented (\chapref[vref]{multipole}).
...
This required a model of the magnetic forces between a cylindrical magnet and a coil, and a particularly efficient new method for calculating the axial force between a cylindrical magnet and an electromagnetic coil with many radial windings was presented (\secref[vref]{magcoil-theory}).
